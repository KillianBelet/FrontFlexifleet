...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\GetApiController' => 'getGetApiControllerService',
            'App\\Controller\\PatchApiController' => 'getPatchApiControllerService',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.request', [0 => #[\Closure(name: 'api_platform.listener.request.add_format', class: 'ApiPlatform\\Core\\EventListener\\AddFormatListener')] function () {
            return ($this->privates['api_platform.listener.request.add_format'] ?? $this->getApiPlatform_Listener_Request_AddFormatService());
        }, 1 => 'onKernelRequest'], 7);
        $instance->addListener('kernel.request', [0 => #[\Closure(name: 'api_platform.listener.request.read', class: 'ApiPlatform\\Core\\EventListener\\ReadListener')] function () {
            return ($this->privates['api_platform.listener.request.read'] ?? $this->getApiPlatform_Listener_Request_ReadService());
        }, 1 => 'onKernelRequest'], 4);
        $instance->addListener('kernel.view', [0 => #[\Closure(name: 'api_platform.listener.view.write', class: 'ApiPlatform\\Core\\EventListener\\WriteListener')] function () {
            return ($this->privates['api_platform.listener.view.write'] ?? $this->load('getApiPlatform_Listener_View_WriteService'));
        }, 1 => 'onKernelView'], 32);
        $instance->addListener('kernel.request', [0 => #[\Closure(name: 'api_platform.listener.request.deserialize', class: 'ApiPlatform\\Core\\EventListener\\DeserializeListener')] function () {
            return ($this->privates['api_platform.listener.request.deserialize'] ?? $this->getApiPlatform_Listener_Request_DeserializeService());
        }, 1 => 'onKernelRequest'], 2);
        $instance->addListener('kernel.view', [0 => #[\Closure(name: 'api_platform.listener.view.serialize', class: 'ApiPlatform\\Core\\EventListener\\SerializeListener')] function () {
            return ($this->privates['api_platform.listener.view.serialize'] ?? $this->load('getApiPlatform_Listener_View_SerializeService'));
        }, 1 => 'onKernelView'], 16);
        $instance->addListener('kernel.view', [0 => #[\Closure(name: 'api_platform.listener.view.respond', class: 'ApiPlatform\\Core\\EventListener\\RespondListener')] function () {
            return ($this->privates['api_platform.listener.view.respond'] ?? $this->load('getApiPlatform_Listener_View_RespondService'));
        }, 1 => 'onKernelView'], 8);
        $instance->addListener('kernel.exception', [0 => #[\Closure(name: 'api_platform.listener.exception.validation', class: 'ApiPlatform\\Core\\Bridge\\Symfony\\Validator\\EventListener\\ValidationExceptionListener')] function () {
        ...
        $instance->addListener('kernel.exception', [0 => #[\Closure(name: 'api_platform.listener.exception', class: 'ApiPlatform\\Core\\EventListener\\ExceptionListener')] function () {
        ...
        $instance->addListener('kernel.request', [0 => #[\Closure(name: 'api_platform.swagger.listener.ui', class: 'ApiPlatform\\Core\\Bridge\\Symfony\\Bundle\\EventListener\\SwaggerUiListener')] function () {
        ...
        $instance->addListener('kernel.response', [0 => #[\Closure(name: 'api_platform.hydra.listener.response.add_link_header', class: 'ApiPlatform\\Core\\Hydra\\EventListener\\AddLinkHeaderListener')] function () {
        ...
        $instance->addListener('kernel.response', [0 => #[\Closure(name: 'api_platform.http_cache.listener.response.configure', class: 'ApiPlatform\\Core\\HttpCache\\EventListener\\AddHeadersListener')] function () {
        ...
        $instance->addListener('kernel.view', [0 => #[\Closure(name: 'api_platform.listener.view.validate', class: 'ApiPlatform\\Core\\Validator\\EventListener\\ValidateListener')] function () {
            return ($this->privates['api_platform.listener.view.validate'] ?? $this->load('getApiPlatform_Listener_View_ValidateService'));
        }, 1 => 'onKernelView'], 64);
        $instance->addListener('kernel.request', [0 => #[\Closure(name: 'api_platform.listener.view.validate_query_parameters', class: 'ApiPlatform\\Core\\EventListener\\QueryParameterValidateListener')] function () {
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WQ0QBHbE0B', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mu1xpqqFZz', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('N+pkKLLRpx', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RmRa-VAH2k', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5JcJCvRKX4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3gXuvtK6ee', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getSerializerService()
    {
        ...
        $r = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($q, $m, $a, $b, new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($q), NULL, []);
